...
| `reaper/presets/vst3-Eclipsa Audio Element Plugin.ini` | Eclipsa Audio Element Plugin preset `3OA_passthrough`, for the IAMF/Eclipsa third-order Ambisonic encoding stage. |
| `reaper/presets/vst3-Eclipsa Audio Renderer.ini` | Eclipsa Audio Renderer preset `3OA_to_binaural`, for the corresponding EAR binaural render. |
