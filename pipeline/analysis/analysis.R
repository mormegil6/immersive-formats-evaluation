...
## Optional 4th argument: a human-readable transcript of this run. It is a
## verbatim capture of the console output rather than a hand-written summary,
## so it cannot drift from the numbers the analysis actually produced.
...
if (!is.na(REPORT)) {
  ...
  writeLines(c(
    "# Analysis report",
    "",
    paste0("Generated by `pipeline/analysis/analysis.R`. This file is a verbatim",
           " capture of the analysis console output; do not edit it by hand."),
    "",
    "```"), con)
  sink(con, split = TRUE)
